...
class TextClassificationModel(nn.Module):
    def __init__(self):
        super().__init__()
        self.embedding = nn.EmbeddingBag(vocab_size, 64, sparse=True)
...
plt.scatter(epochs, loss_values, color='red', zorder=5, label='SGD')
...
# Точки шагов SGD
plt.scatter(iterations, loss_values, color='red', s=20, label='Шаги SGD (итерации)')
